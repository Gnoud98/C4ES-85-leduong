// // console.log('Basic part1');
// // for (let i = 0; i <= 1; i++);
// // console.log(Math.random());
// // console.log('part2')
// // let numbers = [2, 3, 5, 6, 7, 8, 9];
// // let rand = numbers[(Math.random() * numbers.length) | 0]
// // console.log(rand);
// console.log('part3');
// let quizs = [];
// let question1 = {
//     ask: "Bac Ho sinh nam bao nhieu",
//     answer: [
//         '1. 1890',
//         '2. 1800',
//         '3. 1900',
...
//     rightChoice: '4',
// };
// quizs.push(question1);
// quizs.push(question2);
// quizs.push(question3);
// quizs.push(question4);
// let randomQuestions = quizs[Math.floor(Math.random() * quizs.length)];
// console.log(randomQuestions);
// let userAnswer = prompt(randomQuestions.ask + randomQuestions.answer[0] + randomQuestions.answer[1] + randomQuestions.answer[2] + randomQuestions.answer[3]);
// if (userAnswer == randomQuestions.rightChoice) {
//     alert('bravo!');
// } else {
//     alert('Good luck next time !!!')
// };
// console.log("lab2 par1")
// jobDatas = {
//     hits: [{
//             benefits: [{
...
// console.log(dataList.hits);

// console.log("Get the first job hit: ");
// console.log(dataList.hits[0]);

// console.log("First job title:");
// console.log(dataList.hits[0].jobTitle);

// console.log("Get the benefits of the first job hit:");
// console.log(dataList.hits[0].benefits);

// console.log("First job hit benefit:");
// for (let item in dataList.hits[0].benefits) {
//     console.log(" - " + dataList.hits[0].benefits[item].benefitValue);
// }

// console.log("Log out jobTitle and benefitValue of ALL job hits: ");
// for (let item in dataList.hits) {
//     console.log(dataList.hits[item].jobTitle);
//     console.log("Benefits: ");
//     for (let itemBenefit in dataList.hits[item].benefits) {
//         console.log(" - " + dataList.hits[item].benefits[itemBenefit].benefitValue);
//     }
// };
// console.log("lab 3")
// let wordList = [
...
//     if (!countWord[wordList[i]]) {
//         countWord[wordList[i]] = 0;
//     }
//     countWord[wordList[i]]++;
// }
// for (let item in countWord) {
//     console.log(item + ": " + countWord[item]);
// }
