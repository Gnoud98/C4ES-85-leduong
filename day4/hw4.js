// console.log("Bai1----for and object");
// const product = {
...
// console.log("3.1. The data type of the outermost layer: Object") // {}
// console.log("3.2  The hits property is where the job results are stored: Array") //có ngoặc []
// console.log("3.3. the job’s title, locations, salary, benefits, skills and requirements");
// console.log("Bài 4");
// let dictionary = {
...
//     if(userKey == dicValue){
//         alert(userKey + ": " + dictionary[dicValue]);
//         break;
//     }
// }
// if(userKey != dicValue ){
//     alert("We could not find your word: " + userKey);
// }
...
//     if(product.category == categoryValues) {
